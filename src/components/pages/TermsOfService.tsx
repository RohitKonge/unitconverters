    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-3">Conduct</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-3">Limitations of Liability</h2>
            <p className="text-gray-600 mb-4 uppercase">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-3">Jurisdiction</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-3">Partial Invalidity</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-3">Violation of Terms</h2>
            <p className="text-gray-600 mb-4">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">General</h2>
